...
def main():
    ...
    print(f"Weighted score for Midterm 1: {midterm_score}")
    print(f"Weighted score for Midterm 2: {midterm_score2}")
    print(f"Weighted score for Final: {final_score}")
...
def get_weighted_score(earned, total, weight):
    ...
    weighted = round((earned / total) * weight, 1)
